...
function buildWisdomPrompt(args: {
  ...
  return [
    ...
    '',
    'CRITICAL: Do NOT include instruction labels like "Say:", "Explain:", "Add:", "Practice saying:", "Step 1:", etc. in your steps. Each step must be ONLY the actual words or action the user should take.',
    'Your steps should be the exact content the user needs, not instructions about how to format them.',
    '',
