...
const DashboardHomeScreen: React.FC<DashboardHomeScreenProps> = ({ navigation }) => {
  ...
  const motivationalMessages = [
    ...
    'Return to what God is teaching you',
    'A quiet place to keep walking with Him',
    'Come back to your walk of faith',
    'Reflect on God\'s faithfulness',
    'Your space to remember His goodness',
    'Continue in what the Lord is doing',
    'Revisit the truths He\'s shown you',
    'Stay rooted in His Word',
    'A calm return to your journey with Christ',
    'Carry on in the grace you\'ve received',
    'Here to help you keep following Jesus',
    'Rest, remember, and rise in faith',
    'Your notes on God\'s work in you',
    'Keep pressing forward in hope',
    'A gentle space for ongoing faith',
    'Hold fast to what God has given',
    'Come back and keep growing in Him',
    'Your quiet corner of faithfulness',
    'Revisit God\'s hand in your life',
    'Walk on in the light you\'ve received',
    'Anchored in His promises',
    'A place to keep trusting Him',
    'Reflect and keep following',
    'Saved truths for your daily walk',
    'Return to the path of obedience',
    'Here with yesterday\'s mercies',
    'Continue your conversation with God',
    'Stay close to what He\'s saying',
    'A faithful space to keep going',
    'Pick up your cross and continue',
    'Remember and rejoice in His love',
    'Your dashboard of grace-filled steps',
    'Keep abiding in what He\'s planted',
    'Return to steady faith',
    'A calm place to realign with Christ',
    'Hold onto the hope you\'ve found',
    'Keep walking in His steadfast love',
    'Revisit His mercies anew',
    'Your space to keep depending on Him',
    'Return and keep running the race',
  ];
  ...
  useEffect(() => {
    ...
    const playbookDeletedSubscription = DeviceEventEmitter.addListener('playbook_deleted', () => {
      fetchFaithfulActions();
    });

    return () => {
      playbookDeletedSubscription.remove();
    };
  }, [user?.id]);
