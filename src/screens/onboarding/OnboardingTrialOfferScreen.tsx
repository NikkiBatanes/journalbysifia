        ...
        <View style={styles.modalOverlay}>
          <View style={styles.planModal}>
            <View style={styles.modalHeader}>
              <ThemedText weight="semiBold" style={styles.modalTitle}>Choose Your Plan</ThemedText>
              <TouchableOpacity
            ...
            <View style={styles.planModalOptions}>
              {pricingTiers.map((tier) => (
                <TouchableOpacity
                  key={tier.id}
                  style={[
                    styles.planModalOption,
                    selectedTierId === tier.id && styles.selectedPlanModalOption,
                  ]}
                  onPress={() => {
                ...
                >
                  <View style={styles.planModalContent}>
                    <ThemedText
                      ...
                      style={[
                        styles.planModalTitle,
                        selectedTierId === tier.id && styles.selectedPlanModalTitle,
                      ]}
                    >
                    ...
                    <ThemedText
                      style={[
                        styles.planModalPrice,
                        selectedTierId === tier.id && styles.selectedPlanModalPrice,
                      ]}
                    >
                      {isAnnual ? `$${(tier.annualPrice || 0).toFixed(2)}/year` : `$${(tier.monthlyPrice || 0).toFixed(2)}/month`}
                    </ThemedText>
                  </View>
      ...
      <View style={styles.scrollContainer}>
        ...
        <View style={styles.contentWrap}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <ThemedText style={styles.planSelectorButtonText}>
