  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['left', 'right']}>
      ...
      <View style={[styles.header, {top: topInset}]}>
        <HeaderBackButton onPress={() => {triggerLightHaptic(); navigation.goBack();}} color={Colors.text} />
      ...
      <ScrollView contentContainerStyle={[styles.content, {paddingTop: topInset + 58, paddingBottom: insets.bottom + 30}]} showsVerticalScrollIndicator={false}>
