  ...
  private baseUSDPricing: PricingTier[] = [
    {
      ...
      secondaryDescription: 'For occasional moments and steady encouragement.',
      features: [
        '10 playbooks',
    ...
    },
    {
      ...
      secondaryDescription: 'More room than Growth for people who want frequent return and deeper use.',
      features: [
        '60 playbooks',
