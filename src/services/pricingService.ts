  ...
  private baseUSDPricing: PricingTier[] = [
    {
      ...
      name: 'Spark',
      duration: '12 months',
      description: 'For steady encouragement',
      features: [
        '8 playbooks each month',
        '8 devotionals each month',
        '1-day and 3-day devotionals',
        'Gentle reminders to help you stay attentive',
        'Basic journaling and progress tracking',
      ],
      monthlyPrice: 7.99,
    ...
    },
    {
      ...
      name: 'Transformation',
      duration: '12 months',
      description: 'For seasons of deep work',
      features: [
        'All in Growth, plus:',
        'Unlimited playbooks and devotionals',
        'All devotional lengths (1-7 days)',
        'Priority support',
      ],
      monthlyPrice: 24.99,
