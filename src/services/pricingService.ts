  ...
  private baseUSDPricing: PricingTier[] = [
    {
      ...
      secondaryDescription: 'For occasional moments, steady encouragement, and shorter devotionals.',
      features: [
        '10 playbooks',
        '10 devotionals',
        '1 & 3-day devotionals',
    ...
    },
    {
      ...
      name: 'Transformation',
      duration: '12 months',
      description: 'For ongoing use',
      secondaryDescription: 'More room than Growth for people who want frequent return, deeper use, and longer devotionals.',
      features: [
        'More room than Growth',
        'longer devotional access',
        'more frequent return',
        'deeper use across moments',
        'priority support',
      ],
      monthlyPrice: 24.99,
