...
export interface ReviewQASeedScope {
...
const MORNING_WEEK: MorningDay[] = [
  {
    ...
    underneathIt:
      'A new week feels like a fresh start. I want to move with purpose without rushing ahead of God.',
    scripture: {
      reference: 'Romans 15:13',
      passageReference: 'Romans 15:13',
      poolKey: 'hopeful',
    },
    ...
    focus: {
      ...
      iconType: 'ionicons',
      personalText:
        'Give my best attention to the work that matters most, one faithful step at a time.',
    },
    todos: [
      ...
      {
        text: 'Refill the water bottle before the afternoon block',
        completed: true,
      },
  ...
  },
  {
    ...
    underneathIt:
      'There are too many moving pieces in my head. I need help deciding what is actually mine to carry today.',
    scripture: {
    ...
    focus: {
      ...
      iconType: 'material',
      personalText:
        'Be present in the conversations at home instead of bringing every unfinished task with me.',
    },
    todos: [
  ...
  },
  {
    ...
    feelingIconType: 'ionicons',
    underneathIt:
      'Yesterday was heavy, but I can see a clear next step now. I feel supported and less alone in it.',
    scripture: {
    ...
    focus: {
      ...
      iconType: 'material',
      personalText:
        'Listen carefully and make room for an honest conversation.',
    },
    todos: [
      {
        text: 'Call Mom and listen without multitasking',
        completed: true,
        priority: true,
      },
  ...
  },
  {
    ...
    feelingIconType: 'material',
    underneathIt:
      'My body feels slower this morning. I want to respect that instead of treating rest like something I have to earn.',
    scripture: {
      reference: 'Psalm 4:8',
    ...
    focus: {
      ...
      iconType: 'material',
      personalText:
        'Choose a gentler pace and leave margin between responsibilities.',
    },
    todos: [
  ...
  },
  {
    date: '2026-09-18',
    feeling: 'Calm',
    feelingIcon: 'water-outline',
    feelingIconType: 'ionicons',
    underneathIt:
      'Things are not all finished, but my heart feels quieter. I can work from peace instead of pressure.',
    scripture: {
      reference: 'John 14:27',
      passageReference: 'John 14:27',
      poolKey: 'calm',
    },
    ...
    focus: {
      ...
      iconType: 'material',
      personalText:
        'Complete the promises I already made before taking on something new.',
    },
    todos: [
  ...
  },
  {
    date: '2026-09-19',
    feeling: 'Grateful',
    feelingIcon: 'hand-heart',
    feelingIconType: 'material',
    underneathIt:
      'I am noticing how much goodness was tucked inside an imperfect week—help, laughter, enough strength, and small answers.',
    scripture: {
      reference: '1 Thessalonians 5:18',
      passageReference: '1 Thessalonians 5:16-18',
      poolKey: 'grateful',
    },
    psalm: {
      number: 6,
    ...
    focus: {
      ...
      iconType: 'material',
      personalText:
        'Let today hold worship, delight, and rest instead of becoming another catch-up day.',
    },
    todos: [
  ...
  },
  {
    ...
    feelingIconType: 'ionicons',
    underneathIt:
      'I feel ready for the week ahead, but I want to begin by listening instead of immediately planning every detail.',
    scripture: {
      reference: 'Lamentations 3:22-23',
      passageReference: 'Lamentations 3:22-23',
      poolKey: 'hopeful',
    },
    ...
    focus: {
      ...
      iconType: 'material',
      personalText:
        'Begin the new week by remembering who God is before deciding what I need to accomplish.',
    },
    todos: [
      {
        text: 'Prepare clothes and breakfast for Monday',
        completed: true,
        priority: true,
      },
      {
        text: 'Write the three most important tasks for tomorrow',
        completed: false,
      },
    ],
  },
...
export const seedWeeklyMorningFlow = async (
  manifest: ReviewQASeedManifest,
  ...
  for (const sourceDay of sourceDays) {
    ...
    const checkInId = await putSingleton(
      manifest,
      'morning_check_in',
      day,
      {
    ...
    if (day.psalm) {
      const psalmId = `${REVIEW_QA_PREFIX}${namespace}:morning-psalm:${day.date}`;
      ...
      await putIndexedRecord(
        ...
        psalmId,
        {
          ...
          metadata: {
            source: 'morning_psalm',
            psalmNumber: day.psalm.number,
            psalmReference: `Psalm ${day.psalm.number}`,
            psalmRead: true,
    ...
    if (day.focus) {
      const focusId = await putSingleton(
        manifest,
        'todays_focus',
        day,
        {
    ...
    if (day.todos?.length) {
      ...
      for (const [index, todo] of day.todos.entries()) {
        const id = `${REVIEW_QA_PREFIX}${namespace}:todo:${day.date}:${
          index + 1
        }`;
        await putIndexedRecord(
          manifest,
    ...
    await AsyncStorage.setItem(
      routineKey,
      JSON.stringify({
        id: `${REVIEW_QA_PREFIX}${namespace}:morning-routine:${day.date}`,
        routine: 'morning',
        selected_date: day.date,
        ...
        completed_at:
          day.psalm && day.focus && day.todos?.length
            ? `${day.date}T07:15:00.000Z`
            : undefined,
        content_refs: refs,
      }),
    );
