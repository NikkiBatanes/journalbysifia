    ...
    >
      ...
      {((type.key === 'supplication' || type.key === 'freeform') && prayer.metadata?.track_answered === true) && (
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Ionicons name={prayer.answered_at ? "checkmark-circle" : "checkmark"} size={18} color={prayer.answered_at ? Colors.alertCoral : Colors.hopeWhite} />
      ...
      {supplicationPrayer && supplicationPrayer.metadata?.track_answered === true && (
        <View style={styles.trackingSection}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <Ionicons name={supplicationPrayer.answered_at ? "checkmark-circle" : "checkmark"} size={18} color={supplicationPrayer.answered_at ? Colors.alertCoral : Colors.hopeWhite} />
