  ...
  return <Modal visible animationType="slide" onRequestClose={() => !saving && onClose()}>
    <View style={styles.page}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 18, paddingBottom: insets.bottom + 24 }}>
        ...
        {onDelete && <TouchableOpacity disabled={saving} onPress={() => { triggerLightHaptic(); return (remove)(); }} style={styles.delete}><Ionicons name="trash-outline" size={19} color={Colors.error} /><ThemedText weight="semiBold" style={{ color: Colors.error, fontSize: 14 }}>Delete this prayer</ThemedText></TouchableOpacity>}
      </ScrollView>
