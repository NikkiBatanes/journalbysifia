...
export const GUIDED_REFLECTION_PATHS: readonly GuidedReflectionPath[] = [
  {
    ...
    steps: [
      { id: 'space', eyebrow: "WHAT'S TAKING UP SPACE?", prompt: 'Tap everything that is on your mind.', interactionType: 'multi_select', options: ['Work', 'Money', 'Family', 'Relationship', 'Health', 'A decision', 'The future', 'Church / ministry', 'Something else'], optionalWrite: { label: 'Write about this', prompt: 'What else is taking up space?' }, allowNotes: true },
      ...
      { id: 'attention', eyebrow: 'LOOK CLOSER', prompt: 'What about this is actually asking for your attention?', interactionType: 'write', required: true, allowNotes: true },
      { id: 'discern', eyebrow: 'DISCERN', prompt: 'Name what is yours to carry and what you need to entrust to God.', interactionType: 'paired_write', fields: [{ id: 'mine', label: 'MINE TO CARRY' }, { id: 'entrust', label: 'ENTRUST TO GOD' }], allowNotes: true },
      { id: 'need', eyebrow: 'BRING IT TO GOD', prompt: 'What do you most need from God here?', interactionType: 'multi_select', options: ['Wisdom', 'Peace', 'Courage', 'Patience', 'Trust', 'Strength'], optionalWrite: { label: 'Write a prayer', prompt: 'Bring what you need before God.' }, allowNotes: true },
