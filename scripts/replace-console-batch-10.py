#!/usr/bin/env python3
"""
Careful Console Log Replacement - Batch of 10 files
"""
...
def get_relative_import_path(file_path):
    ...
    if '/services/api/' in file_path or '/services/cache/' in file_path:
        return '../../utils/ProductionLogger'
    elif '/services/' in file_path:
        return '../utils/ProductionLogger'
    elif '/components/journal/' in file_path or '/components/dashboard/' in file_path:
        return '../../utils/ProductionLogger'
    elif '/components/' in file_path or '/screens/' in file_path or '/utils/' in file_path:
        return '../utils/ProductionLogger'
    else:
        return '../utils/ProductionLogger'
...
def replace_simple_console_logs(file_path):
    ...
    # Skip ProductionLogger.ts and enterpriseLogger.ts
    if 'ProductionLogger.ts' in file_path or 'enterpriseLogger.ts' in file_path:
...
if __name__ == "__main__":
    files = [
        ...
        'src/components/ActionStepsCard.tsx',
        'src/services/predictiveContentEngine.ts',
